...
public class ImageControllerTest {
  ...
  public void testGreyscaleRedInput() {
    ...
    assertTrue(log.toString().contains("greyscale: Red, nyc, redNyc"));
  ...
  public void testGreyscaleGreenInput() {
    ...
    assertTrue(log.toString().contains("greyscale: Green, nyc, redNyc"));
  }
  ...
  public void testGreyscaleBlueInput() {
    ...
    assertTrue(log.toString().contains("greyscale: Blue, nyc, redNyc"));
  }
  ...
  public void testGreyscaleValueInput() {
    ...
    assertTrue(log.toString().contains("greyscale: Value, nyc, redNyc"));
  }
  ...
  public void testGreyscaleIntensityInput() {
    ...
    assertTrue(log.toString().contains("greyscale: Intensity, nyc, redNyc"));
  }
  ...
  public void testGreyscaleLumaInput() {
    ...
    assertTrue(log.toString().contains("greyscale: Luma, nyc, redNyc"));
  }
  ...
  public void testGreyscaleSepiaInput() {
    ...
    assertTrue(log.toString().contains("greyscale: Sepia, nyc, sepiaNyc"));
  }
  ...
  // testing if the save is inputted
  // it should not have saved the input, it should have checked the two exceptions
  @Test
  public void testSaveInput() {
    ...
    ImageView view = new ImageTextView(model, dontCareOutput);
    StringReader in = new StringReader("load res/onePPM.ppm nyc " +
            "save res/testInput.ppm testInput q");
    ImageController controller = new ImageControllerImpl(model, view, in);
    controller.modifyImages();

    assertTrue(log.toString().contains("load was called with imagePath = " +
            "res/onePPM.ppm, name = nyc"));
    assertTrue(log.toString().contains("hasLoadedImage called with testInput"));
    assertFalse(log.toString().contains("testInput has been saved, " +
            "saveImage is being called"));
  }
